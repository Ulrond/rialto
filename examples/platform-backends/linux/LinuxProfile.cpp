...
// Linux is just another SoC: the reference profile is the peer with generic auto-sinks, no SoC audio
// path (so it is video-master and uses the generic sink "audio-fade"), and the split decode topology.
